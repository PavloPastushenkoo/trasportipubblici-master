...
//        System.out.println("Stai acquistando " + biglietti + " biglietti per un viaggio da " + inizio + " fino a " + arrivo);
        ...
        Biglietto biglietto2 = new Biglietto(true, LocalTime.of(12,23,22), LocalTime.of(13,50,55), utente2, tratta5, distributore2);
        Biglietto biglietto3 = new Biglietto(false, LocalTime.of(20,50,11), LocalTime.of(22,10,12), utente3, tratta2, distributore3);
        ...
        Biglietto biglietto6 = new Biglietto(false, LocalTime.of(10,20,25),LocalTime.of(11,50,55), utente1, tratta1, distributore1);
        Biglietto biglietto7 = new Biglietto(true, LocalTime.of(12,23,22), LocalTime.of(13,50,55), utente2, tratta5, distributore2);
        Biglietto biglietto8 = new Biglietto(false, LocalTime.of(20,50,11), LocalTime.of(22,10,12), utente3, tratta2, distributore3);
        Biglietto biglietto9 = new Biglietto(true, LocalTime.of(12,23,22), LocalTime.of(13,50,55), utente4, tratta3, rivenditore1);
        Biglietto biglietto10 = new Biglietto(false, LocalTime.of(20,50,11), LocalTime.of(22,10,12), utente2, tratta4, rivenditore1);
        Biglietto biglietto11 = new Biglietto(false, LocalTime.of(20,50,11), LocalTime.of(22,10,12), utente3, tratta2, distributore3);
...
//        System.out.println(distributoreAutomaticoDao.getBigliettiPerDistributoreAutomatico());
        ...
        for (Object[] result : results) {
            ...
            BigInteger numeroBiglietti = (BigInteger) result[1];

            System.out.println("ID Distributore: " + distributoreId + ", Numero di Biglietti: " + numeroBiglietti);
        }
